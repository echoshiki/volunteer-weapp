import { DemandOrderAcceptStatus, ServiceScope } from '@/types/demand';

// 兼容你 Badge 组件的 variant 属性
type BadgeVariant = 'primary' | 'success' | 'warning' | 'danger' | 'gray';

/** 需求订单状态 UI 配置字典 */
export const DEMAND_ACCEPT_STATUS_MAP: Record<
	DemandOrderAcceptStatus,
	{ label: string; variant: BadgeVariant }
> = {
	dispatching: { label: '招募中', variant: 'primary' },
	accepted: { label: '已接单', variant: 'warning' },
	serving: { label: '服务中', variant: 'warning' }, // ✨ 注意这里对齐了你新定义的 serving
