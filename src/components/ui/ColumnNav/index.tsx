 ...
 */
export const ColumnNav = ({ icon, label, border = true, type, extra, onClick }: ColumnNavProps) => (
	<Button
	...
	>
		...
		{extra && <View className="flex items-center text-xs text-text-muted">{extra}</View>}
