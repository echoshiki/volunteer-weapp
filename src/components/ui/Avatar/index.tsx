 ...
 * 在无头像时显示首字母
 */
export const Avatar = ({ src, name = 'U', size = 'md', className = '' }: AvatarProps) => {
	...
	return (
		<View
			className={`rounded-full overflow-hidden flex items-center justify-center shrink-0 border-2 border-white/10 ${SIZE_MAP[size]} ${className}`}
		>
			{src && !isError ? (
				<Image
					src={src}
