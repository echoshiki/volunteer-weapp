	...
	return (
		<Page className="flex flex-col justify-between items-center px-10 py-20">
			...
			<View className="w-full flex flex-col gap-4">
				...
				{authStage === 'UNLOGIN' && (
					<Button size="xl" variant="primary" onClick={onManualLogin}>
						微信一键登录
					</Button>
				)}
			...
			<View className="pb-10">
				<Text className="text-xs text-gray-400">
					...
					<Text
						...
						onClick={() => mapsTo(config.agreementUrl || '/pages/home/index')}
					>
						《用户协议》
					</Text>{' '}
					与{' '}
					<Text
						className="text-blue-500"
						onClick={() => mapsTo(config.policyUrl || '/pages/home/index')}
					>
						《隐私政策》
					</Text>
				</Text>
